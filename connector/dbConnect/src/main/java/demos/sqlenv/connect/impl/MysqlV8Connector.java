...
public class MysqlV8Connector implements Connector {
    ...
    public Connection toConnect(TSQLDataSource datasource) throws Exception {
        ...
        return ConnectUtil.getConnection(datasource.getAccount(), datasource.getPassword(),
                ConnectConstant.MYSQLV8.getDriver(),
                String.format(ConnectConstant.MYSQLV8.getUrl(), address, datasource.getDatabase()).replace("/null", ""),  datasource.getTimeout());
    }
