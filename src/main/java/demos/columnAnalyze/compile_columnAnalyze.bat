...
call setenv\setenv.bat
    ...
    echo ***************************
    echo.
    cd src\main\java\demos\columnAnalyze
    pause
    goto END
    )
...
%JAVAC_CMD% -d %targetdir% -classpath %CLASSPATH% src\main\java\demos\columnImpact\*.java src\main\java\demos\columnAnalyze\*.java
