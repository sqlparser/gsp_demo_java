...
%JAVAC_CMD% -d %targetdir% -classpath %CLASSPATH% src\demos\joinConvert\*.java src\demos\sqltranslator\exception\*.java src\demos\sqltranslator\*.java
