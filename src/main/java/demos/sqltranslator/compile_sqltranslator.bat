...
call setenv\setenv.bat
    ...
    echo ***************************
    echo.
    cd src\main\java\demos\sqltranslator
    pause
    goto END
    )
...
%JAVAC_CMD% -d %targetdir% -classpath %CLASSPATH% src\main\java\demos\joinConvert\*.java src\main\java\demos\sqltranslator\exception\*.java src\main\java\demos\sqltranslator\*.java
