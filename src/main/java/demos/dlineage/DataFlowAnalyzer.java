...
public class DataFlowAnalyzer {
	...
	public static void main(String[] args) {
		if (args.length < 1) {
			System.out.println(
					"Usage: java DataFlowAnalyzer [/f <path_to_sql_file>] [/d <path_to_directory_includes_sql_files>] [/stat] [/removeResultSetTypes <resultset_types>] [/removeVariable /removeCursor] [/s [/topselectlist] [/text] [/withTemporaryTable]] [/i] [/showResultSetTypes <resultset_types>] [/showVariable] [/showCursor] [/ic] [/lof] [/j] [/json] [/traceView] [/t <database type>] [/o <output file path>] [/version] [/env <path_to_metadata.json>]  [/tableLineage [/csv [/delimeter <delimeter>]]] [/transform [/coor]] [/showConstant] [/showER] [/treatArgumentsInCountFunctionAsDirectDataflow] [/filterRelationTypes <relationTypes>] [/lv]");
			...
			System.out.println("/showCursor: Optional. Optional. This option is valid only when /s or /i option is used, and is used to reserve all the cursors.");
