...
%JAVAC_CMD% -d %targetdir% -classpath %CLASSPATH% src\main\java\demos\*.java src\main\java\gudusoft\gsqlparser\demos\gettablecolumns\*.java src\main\java\gudusoft\gsqlparser\demos\gettablecolumns\*.java
