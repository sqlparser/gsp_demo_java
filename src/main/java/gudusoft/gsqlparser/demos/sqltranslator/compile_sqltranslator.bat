...
%JAVAC_CMD% -d %targetdir% -sourcepath src\main\java -classpath %CLASSPATH% src\main\java\gudusoft\gsqlparser\demos\sqltranslator\*.java src\main\java\gudusoft\gsqlparser\demos\sqltranslator\exception\*.java src\main\java\gudusoft\gsqlparser\demos\sqltranslator\*.java
