...
public class testCopyInto extends TestCase {
    ...
    public void test1(){
        ...
        TSnowflakeCopyIntoStmt copyIntoStmt = (TSnowflakeCopyIntoStmt)sqlparser.sqlstatements.get(0);
        assertTrue(copyIntoStmt.getCopyIntoType() == TSnowflakeCopyIntoStmt.COPY_INTO_TABLE);
    ...
    public void testIntoLocation(){
        ...
        TSnowflakeCopyIntoStmt copyIntoStmt = (TSnowflakeCopyIntoStmt)sqlparser.sqlstatements.get(0);
        assertTrue(copyIntoStmt.getCopyIntoType() == TSnowflakeCopyIntoStmt.COPY_INTO_LOCATION);
        assertTrue(copyIntoStmt.getTableName().toString().equalsIgnoreCase("mytable"));
