...
public class testMySQLFiles extends TestCase {
    ...
    public  void testMySQL(){
        parseTest.parsefiles(EDbVendor.dbvmysql,test.gspCommon.BASE_SQL_DIR+"mysql");
        parseTest.parsefiles(EDbVendor.dbvmysql,test.gspCommon.BASE_SQL_DIR+"java/mysql");
