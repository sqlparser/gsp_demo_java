...
public class testAlterGroup extends TestCase {
    ...
    public void test1() {
        ...
        assertTrue(sqlparser.sqlstatements.get(0).sqlstatementtype == ESqlStatementType.sstredshiftAlterGroup);
        TRedshiftAlterGroup group = (TRedshiftAlterGroup) sqlparser.sqlstatements.get(0);
