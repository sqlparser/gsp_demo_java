...
public class testCreateSchema extends TestCase {
    ...
    public void test1() {
        ...
        assertTrue(sqlparser.sqlstatements.get(0).sqlstatementtype == ESqlStatementType.sstredshiftCreateSchema);
        TRedshiftCreateSchema createSchema = (TRedshiftCreateSchema) sqlparser.sqlstatements.get(0);
        assertTrue(createSchema.getSchemaName().toString().equalsIgnoreCase("us_sales"));
        assertTrue(createSchema.getUserName().toString().equalsIgnoreCase("dwuser"));
    }
