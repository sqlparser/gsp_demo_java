...
public class testClose extends TestCase {
        public void test1() {
            ...
            assertTrue(sqlparser.sqlstatements.get(0).sqlstatementtype == ESqlStatementType.sstredshiftClose);
            TRedshiftClose close = (TRedshiftClose) sqlparser.sqlstatements.get(0);
